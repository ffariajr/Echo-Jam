...
def metronome(request):
    ...
    speech_output = "<speak>" + bpm + " bpm <audio src=" + sssrc + "metronome/" + bpm + "bpm.mp3' /> </speak>"
    should_end_session = False
...
def halp(request):
    ...
    if(feature == "metronome"):
        ...
        speech_output = "You can ask for rhyming words by saying, 'Give me words that rhyme with, Amazon', or, 'Give me synonyms of, Amazon', or, 'Give me synonyms of, noisy, that rhyme with, Amazon', or, 'Give me words used to describe, Amazon'"
    else:
